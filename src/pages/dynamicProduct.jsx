            ...
            <div className={"p-16"} >
                <div className={"product-hero flex flex-row justify-center w-full"} >
                    ...
                    <div className={"product-info w-1/3 ml-4"} >
                        ...
                        <div className={"text-lg my-1 text-gray-500 flex flex-row"}>
                        ...
                        <div className={"p-cost  my-1 text-2xl text-black"}>$192.0</div>
                        <div className={"p-description  my-1 text-xs"}>PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive.</div>
                        <hr/>
                        <div className={"text-xl  my-1"} >
                            Colors: <input type="radio"/>
                        </div>
                        <div className={"text-xl  my-1 flex flex-row align-middle"}>
                            Storage:
